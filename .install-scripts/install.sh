...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/amahmod/dotfiles.git"
[ -z "$progsfile" ] &&
  progsfile="https://raw.githubusercontent.com/amahmod/dotfiles/master/.install-scripts/programs.csv"
...
# Eable global npm package install
sudo -u "$name" mkdir -p "/home/$name/.npm-packages"
npm config set prefix "/home/$name/.npm-packages"
