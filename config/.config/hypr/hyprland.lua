...
hl.bind(
	main_mod .. " + SHIFT + S",
	hl.dsp.exec_cmd(
		[[sh -c 'grim -g "$(slurp)" - | wl-copy && notify-send "Screenshot" "Selection copied to clipboard" -i camera-photo']]
	)
)
hl.bind(
	main_mod .. " + S",
	hl.dsp.exec_cmd(
		[[sh -c 'grim - | wl-copy && notify-send "Screenshot" "Screen captured to clipboard" -i camera-photo']]
	)
)
